...
- `game.ts` — online-play placeholder bootstrap (`game.html`): names the chosen variant and links to the solo fallback. The real lobby + move sync lands with the backend
